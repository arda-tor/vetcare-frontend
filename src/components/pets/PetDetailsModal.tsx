// src/components/pets/PetDetailsModal.tsx
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex items-center">
              ...
              <p className="font-medium text-neutral-800">{pet.age || '—'}</p>
            </div>
          </div>
          ...
          {pet.notes && (
            <div>
              <h3 className="text-lg font-medium text-neutral-800 mb-2">Notes</h3>
          ...
          <div className="border-t border-neutral-200 pt-6">
            <h3 className="text-lg font-medium text-neutral-800 mb-4">Owner</h3>
